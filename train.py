...
ds = DialogueDataset(["F:/nucc/nucc.txt", "F:/logs/nucc_discord_supecial_tokens.txt"], "./sentencepiece.model", join_past_logs=3)
...
responder.train(ds, device=torch.device("cuda"), batch_size=45, num_epoch=100)